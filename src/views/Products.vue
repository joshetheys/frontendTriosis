<template>
    ...
    <router-link to="/router-linkbout">About</router-link> |
    <router-link to="/Products">Products</router-link> |
    <router-link to="/router-linkbout">Products Admin</router-link> |
    <router-link to="/router-linkbout">Login</router-link> |
    <router-link to="/router-linkbout">Sign In</router-link> |
    <router-link to="/router-linkbout">User Admin</router-link> |
